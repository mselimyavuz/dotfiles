...
# CONFIGURATION
# ==========================================
DOTFILES_DIR="$HOME/gentoo-dotfiles-laptop"
...
if [ -d "$DOTFILES_DIR/scripts" ]; then
    for script in "$DOTFILES_DIR/scripts"/*; do
        ...
        if [[ "$script_name" == "polybar-launch.sh" ]]; then
            link_config "$script" "$HOME/.config/polybar/polybar-launch.sh"
        else
...
echo -e "\n${GREEN}::: Setup Complete! Re-login or source ~/.zshrc :::${NC}"
